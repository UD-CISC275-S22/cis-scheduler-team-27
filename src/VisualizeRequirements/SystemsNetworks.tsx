...
export function SystemsNetworks({ plan }: { plan: Plan }): JSX.Element {
                ...
                <Container>
                    <Row>
                        ...
                        <Col>
                            ...
                            <p></p>
                            <div>
                                {conElective.length >= 3 ? (
                                    <div>
                                        <span>
                                            Security Requirements and Advanced
                                            System Requirements 9/9: ✔️
                                        </span>
                                    </div>
                                ) : (
                                    <span>
                                        Security Requirements and Advanced
                                        System Requirements {conElectiveCreds}
                                        /9: ❌
                                    </span>
                                )}
                            </div>
